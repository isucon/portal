...
// file: isuxportal/resources/team.proto
...
export class Team extends jspb.Message {
  ...
  hasLeader(): boolean;
  clearLeader(): void;
  getLeader(): isuxportal_resources_contestant_pb.Contestant | undefined;
  setLeader(value?: isuxportal_resources_contestant_pb.Contestant): void;

  clearMembersList(): void;
  getMembersList(): Array<isuxportal_resources_contestant_pb.Contestant>;
  setMembersList(value: Array<isuxportal_resources_contestant_pb.Contestant>): void;
  addMembers(value?: isuxportal_resources_contestant_pb.Contestant, index?: number): isuxportal_resources_contestant_pb.Contestant;
...
export namespace Team {
  export type AsObject = {
    ...
    leader?: isuxportal_resources_contestant_pb.Contestant.AsObject,
    membersList: Array<isuxportal_resources_contestant_pb.Contestant.AsObject>,
  }
