...
// file: services/dcim/instance_management.proto
...
export class InformInstanceStateUpdateRequest extends jspb.Message {
  ...
  hasInstance(): boolean;
  clearInstance(): void;
  getInstance(): resources_contestant_instance_pb.ContestantInstance | undefined;
  setInstance(value?: resources_contestant_instance_pb.ContestantInstance): void;
...
export namespace InformInstanceStateUpdateRequest {
  export type AsObject = {
    token: string,
    instance?: resources_contestant_instance_pb.ContestantInstance.AsObject,
  }
}
