  ...
  return <div className="card mt-5">
    ...
    <div className="card-content">
      <form onSubmit={onSubmit}>
        <div className="field">
          <label className="label" htmlFor="ContestantClarificationList-question">質問内容</label>
          <div className="control">
            <textarea className="textarea" name="question" id="ContestantClarificationList-question" ref={register} placeholder="" autoFocus />
          </div>
        </div>
        <div className="field">
          <div className="control">
            <button className="button is-primary" type="submit" disabled={requesting}>送信</button>
          </div>
        </div>
