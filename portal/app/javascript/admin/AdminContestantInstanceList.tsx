      ...
      <form onSubmit={onSubmit}>
        <div className="columns">
          <div className="column is-3 field">
            <label className="label" htmlFor="AdminContestantInstanceListFilter-teamId">Team ID</label>
            <div className="control">
              <input className="input" type="text" name="teamId" id="AdminContestantInstanceListFilter-teamId" ref={register} />
            </div>
          </div>
          <div className="column is-3 field">
...
export class AdminContestantInstanceList extends React.Component<Props, State> {
  ...
  renderList() {
    ...
    return <table className="table">
      ...
      <tbody>
        {this.state.list.contestantInstances!.map((ci,i) => this.renderContestantInstance(ci, i))}
      </tbody>
    </table>;
  }
  ...
  renderContestantInstance(ci: isuxportal.proto.resources.IContestantInstance, i: number) {
    ...
    return <tr key={id}>
      ...
      <td><ContestantInstanceStatus status={ci.status!} /></td>
    </tr>;
  }
}
