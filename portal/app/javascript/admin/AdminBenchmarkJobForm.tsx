      ...
      <form onSubmit={onSubmit}>
        <div className="columns">
          <div className="column is-3 field">
            <label className="label" htmlFor="AdminBenchmarkJobForm-teamId">Team ID</label>
            <div className="control">
              <input className="input" type="text" name="teamId" id="AdminBenchmarkJobForm-teamId" ref={register} />
            </div>
          </div>
          <div className="column is-3 field">
            <label className="label" htmlFor="AdminBenchmarkJobForm-targetId">Target ID</label>
            <div className="control">
              <input className="input" type="text" name="targetId" id="AdminBenchmarkJobForm-targetId" ref={register} />
            </div>
          </div>
          <div className="column is-3 field">
