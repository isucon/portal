    ...
    return <>
      <section className="mt-2">
        ...
        <ul>
          ...
          <li>ご登録いただいたチーム名, 代表者名, メンバー名は ISUCON 公式サイトおよびポータルなど上で広く公開されます。GitHub アカウントの情報はチームメンバー内で共有されます。</li>
          <li>競技進行のため、全参加者はサポート/アナウンス用の Discord サーバー (サポートチャット) への参加が必要です。そのため、Discord アカウントの情報は全参加者にも共有されます。</li>
          <li>参加登録が完了すると、他のチームへの参加はできなくなります。</li>
          <li>1人目 (チーム代表者) の登録後、チームメンバーを招待するための URL を確認することができます。招待 URL を共有し、チームメンバー全員の登録をしてください。</li>
  ...
  public renderJoinTeamFormFields() {
    return <>
      <div className="field">
        ...
        <p className="help">公開されます。本名でなくて構いません (id, HN, その他匿名な記入でも問題ありません)。複数名の名前を記載することはできません (2 人目以降の登録は、登録後確認できる招待URLを利用して、それぞれ個別に登録してください)。</p>
      </div>
