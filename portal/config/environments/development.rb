Rails.application.configure do
  ...
  config.hosts << ENV.fetch('DEFAULT_URL_HOST', 'localhost:3000')
  ...
  config.x.ami.test_id = ENV['ISUXPORTAL_TEST_AMI_ID'] || 'ami-x'
  config.x.ami.qualify_id = ENV['ISUXPORTAL_QUALIFY_AMI_ID'] || 'ami-y'
end
