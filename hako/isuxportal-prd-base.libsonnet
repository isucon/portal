...

{
  ...
  app: {
    ...
    env: {
      ...
      ISUXPORTAL_TIMING_CONTEST_START: '2029-09-12T03:20:00Z',
      ISUXPORTAL_TIMING_CONTEST_FREEZE: '2029-09-12T11:00:00Z',
      ISUXPORTAL_TIMING_CONTEST_END: '2029-09-12T12:00:00Z',
      ISUXPORTAL_SHORYUKEN_QUEUE: 'isuxportal-activejob-prd',
      ISUXPORTAL_DOCS_URL: 'https://gist.github.com/progfay/25edb2a9ede4ca478cb3e2422f1f12f6',
    },
    secrets: [
