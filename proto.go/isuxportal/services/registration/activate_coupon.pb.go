...
var file_isuxportal_services_registration_activate_coupon_proto_rawDesc = []byte{
	...
	0x75, 0x70, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x44, 0x5a, 0x42,
...
var file_isuxportal_services_registration_activate_coupon_proto_goTypes = []interface{}{
...
func file_isuxportal_services_registration_activate_coupon_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_isuxportal_services_registration_activate_coupon_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_isuxportal_services_registration_activate_coupon_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
