...
type GetCurrentSessionResponse struct {
	...
	PushVapidKey        []byte                          `protobuf:"bytes,6,opt,name=push_vapid_key,json=pushVapidKey,proto3" json:"push_vapid_key,omitempty"`
}
...
func (x *GetCurrentSessionResponse) GetPushVapidKey() []byte {
	if x != nil {
...
var file_isuxportal_services_common_me_proto_rawDesc = []byte{
	...
	0x0c, 0x52, 0x0c, 0x70, 0x75, 0x73, 0x68, 0x56, 0x61, 0x70, 0x69, 0x64, 0x4b, 0x65, 0x79, 0x42,
