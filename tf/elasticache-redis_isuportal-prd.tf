...
resource "aws_elasticache_replication_group" "isuxportal-prd-b" {
  replication_group_id          = "isuxportal-prd-b"
  replication_group_description = "Redis 2 for isuxportal-prd"
